...
public class TicketJpaRepository implements TicketRepository {
    ...
    @Override
    public List<Ticket> getByFlightId(UUID flightId) throws BusinessRuleValidationException {
        List<TicketJpaModel> jpaModels = ticketCrudRepository.findByFlightId(flightId);
