...
public class SeatJpaRepository implements SeatRepository {
    ...
    @Override
    public List<Seat> findByFlightIdAndStatus(UUID flightId, String status) throws BusinessRuleValidationException {
       List<SeatJpaModel> jpaModels = seatCrudRepository.findByFlightIdAndStatus(flightId, status);
