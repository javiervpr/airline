...
public class BaggageUtils {
    ...
    public static BaggageJpaModel baggageToJpaEntity(Baggage baggage, CheckInJpaModel checkInJpaModel) {
    ...
    public static List<BaggageJpaModel> baggagesToJpaEntities(List<Baggage> baggages, CheckInJpaModel checkInJpaModel) {
        if (baggages == null) return Collections.emptyList();
        return baggages.stream().map((Baggage baggage) -> baggageToJpaEntity(baggage, checkInJpaModel)).toList();
    }

    public static Baggage jpaToBaggage(BaggageJpaModel jpaModel) throws BusinessRuleValidationException {
