...
@Component
public class TagBaggageHandler implements Command.Handler<TagBaggaggeCommand, UUID> {

    private final CheckInRepository checkInRepository;
    private final BaggageRepository baggageRepository;
    private final CheckInFactory checkInFactory;

    public TagBaggageHandler(CheckInRepository checkInRepository, BaggageRepository baggageRepository) {
    ...
    public UUID handle(TagBaggaggeCommand request) {
        ...
        CheckIn checkIn = null;
            checkIn = checkInRepository.findByPassangerAndFlightId(UUID.fromString(request.checkInDto.passanger.id),
