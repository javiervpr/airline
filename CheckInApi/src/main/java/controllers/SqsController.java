...
public class SqsController {
  ...
  public void listenFlightQueue(String message) throws JsonProcessingException {
    ...
    FlightDto flightDto = objectMapper.readValue(
      snsDto.Message,
      FlightDto.class
    );
    ...
    logger.info(
      "message from SQS Queue decoded {}",
      flightDto.data.flight.information.avaibleSeats.toString()
    );
  }

  @SqsListener("passengers_checkin_queue")
  public void listenPassengerQueue(String message)
    throws JsonProcessingException {
    logger.info("message from SQS Queue {}", message);
    ObjectMapper objectMapper = new ObjectMapper();
    SNSDto snsDto = objectMapper.readValue(message, SNSDto.class);
    PassengerSyncDto passengerSyncDto = objectMapper.readValue(
      snsDto.Message,
      PassengerSyncDto.class
    );
  ...
  public void listenPayments(String message) throws JsonProcessingException {
    ...
    ObjectMapper objectMapper = new ObjectMapper();
    SNSDto snsDto = objectMapper.readValue(message, SNSDto.class);
    PaymentCompleteDto paymentCompleteDto = objectMapper.readValue(
      snsDto.Message,
      PaymentCompleteDto.class
    );
